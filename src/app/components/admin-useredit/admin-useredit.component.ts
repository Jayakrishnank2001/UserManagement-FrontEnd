...
@Component({
  ...
  styleUrl: './admin-useredit.component.css'
})
export class AdminUsereditComponent implements OnInit{
  ...
  constructor(private formBuilder:FormBuilder,private http:HttpClient,private router:ActivatedRoute,private route:Router){}
